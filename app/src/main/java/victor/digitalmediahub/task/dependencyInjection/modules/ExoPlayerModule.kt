...
class ExoPlayerModule {
    ...
    @Provides
    internal fun providesProgressiveMediaSource(dataSourceFactory:DefaultDataSourceFactory): ProgressiveMediaSource {
        return ProgressiveMediaSource.Factory(dataSourceFactory) .createMediaSource(Uri.parse(RADIO_URL))
    }
    @Provides
    internal fun providesSimpleExoPlayer(context: Context, mediaSource: ProgressiveMediaSource): SimpleExoPlayer{
